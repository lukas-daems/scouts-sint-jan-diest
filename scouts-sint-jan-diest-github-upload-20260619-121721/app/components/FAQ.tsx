...
const faqs = [
  {
    question: "Vanaf welke leeftijd kan mijn kind aansluiten?",
    answer:
      "Kinderen kunnen aansluiten vanaf de kapoenenleeftijd. Bij Scouts Sint-Jan Diest werken we met takken vanaf 6 jaar.",
  },
  {
    question: "Moet mijn kind al iemand kennen?",
    answer:
  ...
  },
  {
    ...
    answer:
      "De exacte activiteitsmomenten worden door de leiding gecommuniceerd. Voor nieuwe leden geven we graag de juiste info via contact.",
  },
  {
  ...
  {
    question: "Heeft mijn kind een uniform nodig?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Het zomerkamp is een belangrijk deel van het scoutsjaar. Ouders krijgen vooraf alle praktische info, zoals data, locatie, bagagelijst en medische gegevens.",
  },
  {
